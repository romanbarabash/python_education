...
class DefaultApi(object):
    ...
    def create_task(self, body, **kwargs):  # noqa: E501
        ...
        Allows for creating a task.   # noqa: E501
        ...
        :param Task body: The task to create (required)
        :return: None
    ...
    def update_task(self, id, body, **kwargs):  # noqa: E501
        """Updates the details for a task.  # noqa: E501

        Allows for updating a task.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_task(id, body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str id: The id of the task (required)
        :param Task body: The task to update (required)
        :return: Task
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_task_with_http_info(id, body, **kwargs)  # noqa: E501
        else:
            (data) = self.update_task_with_http_info(id, body, **kwargs)  # noqa: E501
            return data

    def update_task_with_http_info(self, id, body, **kwargs):  # noqa: E501
        """Updates the details for a task.  # noqa: E501

        Allows for updating a task.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_task_with_http_info(id, body, async_req=True)
        >>> result = thread.get()
    ...
    def view_task(self, id, **kwargs):  # noqa: E501
        """Gets the details for a task.  # noqa: E501

        The details view of a task.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.view_task(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.view_task_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.view_task_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def view_task_with_http_info(self, id, **kwargs):  # noqa: E501
        """Gets the details for a task.  # noqa: E501

        The details view of a task.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.view_task_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('id' not in params or
                                                       params['id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `id` when calling `view_task`")  # noqa: E501
